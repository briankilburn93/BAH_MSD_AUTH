...
import com.bah.msd.auth.jwt.JWTHelper;
import com.bah.msd.auth.pojos.Customer;
import com.bah.msd.auth.pojos.CustomerFactory;
...
public class TokenApi {
    ...
    private static Token createToken(String username) {
    	String scopes = "com.webage.auth.apis";
    	// special case for application user
    	if( username.equalsIgnoreCase("ApiClientApp")) {
    		scopes = "com.webage.data.apis";
    	}
